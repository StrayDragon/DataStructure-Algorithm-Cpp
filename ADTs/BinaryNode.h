...
public:
		...
		BinaryNode(const E& element) : _element(element) ,_left(nullptr),_right(nullptr){}

		BinaryNode(const E& element, BinaryNode<E>* left, BinaryNode<E>* right) : _element(element), _left(left),
		                                                                      _right(right) {}
		bool isLeaf() const{
